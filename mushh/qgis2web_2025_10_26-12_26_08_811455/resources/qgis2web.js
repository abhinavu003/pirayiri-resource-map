...
map.getView().fit([8520010.934909, 1202440.910523, 8534771.614775, 1211003.252287], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">pirayiri resource map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (433 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Pirayiri is a residential and commercial area in Palakkad, Kerala, India, located approximately 8 km from the city center. It is a developing locality with a mix of peaceful residential neighborhoods and a growing commercial presence, including shops, restaurants, and necessary services like hospitals and medical shops. As of the 2011 census, Pirayiri had a population of over 41,000 and is managed by the Pirayiri Gram Panchayat. ';
            }
